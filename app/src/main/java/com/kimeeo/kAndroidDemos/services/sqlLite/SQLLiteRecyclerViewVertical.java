...
import com.kimeeo.kAndroidDemos.services.rss.RSSDataProviderExample;
 ...
 */
public class SQLLiteRecyclerViewVertical extends ListView{
    @Override
    ...
    protected DataProvider createDataProvider() {
        return new DataProvider(getActivity());
    }
